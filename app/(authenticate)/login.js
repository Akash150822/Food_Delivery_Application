    ...
    useEffect(() => {
      const checkLogin = async () => {
          try {
              ...
              if (token) {
                  // Token exists, but ensure user is authenticated
                  // You may implement additional checks here if needed
    ...
    try {
        ...
        if (error) {
            ...
            if (error.message.includes("Invalid login credentials")) {
                // Set state to display the error message to the user
                // For example:
